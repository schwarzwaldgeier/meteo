 ...
 */
define('PSI_PLUGIN_PSSTATUS_PROCESSES', 'mysqld, sshd, /usr/bin/perl /var/www/BERGSTATION/wetterstation_neu/WETTER_SOCKET, /usr/bin/perl /var/www/BERGSTATION/wetterstation_neu/WETTER_start, /usr/bin/perl /var/www/BERGSTATION/wetterstation/weather_clean, /usr/bin/perl /var/www/BERGSTATION/wetterstation/weather_start, vgetty, apache2');
?>
